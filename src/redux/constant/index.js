export default {
  ...
  POPULAR_REFRESH: 'POPULAR_REFRESH',//趋势数据加载
  POPULAR_REFRESH_SUCCESS: 'POPULAR_REFRESH_SUCCESS',//趋势数据加载成功
  POPULAR_REFRESH_FAIL: 'POPULAR_REFRESH_FAIL',//趋势数据加载失败
  POPULAR_LOAD_MORE_SUCCESS: 'POPULAR_LOAD_MORE_SUCCESS',//趋势更多数据加载成功
  POPULAR_LOAD_MORE_FAIL: 'POPULAR_LOAD_MORE_FAIL',//趋势更多数据加载失败
